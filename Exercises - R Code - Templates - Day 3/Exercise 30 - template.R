...
results.knn <- train(purchased ~ gender + age + city + socioeconomic_status 
                     ...
                     preProcess = "scale",
                     tuneGrid=data.frame(k=*******ADD YOUR CODE HERE*******), 
...
predict(object=results.knn, 
        newdata=data.frame(gender="male",
                           age=30,
                           city=*******ADD YOUR CODE HERE*******,
                           socioeconomic_status="low",
                           sum_of_previous_purchases=*******ADD YOUR CODE HERE*******,
...
# ------------------------------------------------------------------------------
# (a) Class Membership
d$prediction.knn5.class <- predict(object=*******ADD YOUR CODE HERE*******)

# (b) Probability
d$prediction.knn5.prob <- predict(object=*******ADD YOUR CODE HERE*******,
                                  type = *******ADD YOUR CODE HERE*******)[, 2]
