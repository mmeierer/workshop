...
rfm_scores[,overall:=*******ADD YOUR CODE HERE*******(c(recency,frequency,monetary)),by=Customer]
rfm_scores

# 2. Calculation of weighted RFM scores ####
rfm_scores[,weighted_overall1:=*******ADD YOUR CODE HERE*******] 
rfm_scores

rfm_scores[,weighted_overall2:=*******ADD YOUR CODE HERE*******]
rfm_scores

# 3. Divide all customers in 3 distinct RFM groups by rounding the unweighted overall RFM score. ####
#?round
rfm_scores[,group:=*******ADD YOUR CODE HERE*******(*******ADD YOUR CODE HERE*******)]

# 4. Display all customers with the highest achievable rating.
rfm_scores[group==*******ADD YOUR CODE HERE*******]
