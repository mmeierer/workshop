...
RFMfunction <- function(data, weight_recency=1, weight_frequency=1, weight_monetary=1){
  ...
  weight_recency2 <- *******ADD YOUR CODE HERE*******/sum(weight_recency, weight_frequency, weight_monetary)
  weight_frequency2 <- *******ADD YOUR CODE HERE*******/sum(weight_recency, weight_frequency, weight_monetary)
  weight_monetary2 <- *******ADD YOUR CODE HERE*******/sum(weight_recency, weight_frequency, weight_monetary)
  ...
  temp <- data[,list(
    ...
    frequency = .N,
    monetary = *******ADD YOUR CODE HERE*******(PurchAmount)),
    by=Customer
  ]
  ...
  temp <- temp[,list(Customer,
                     recency = as.numeric(cut2(*******ADD YOUR CODE HERE*******, g=*******ADD YOUR CODE HERE*******)),
                     frequency = as.numeric(cut2(*******ADD YOUR CODE HERE*******, g=*******ADD YOUR CODE HERE*******)),
                     monetary = as.numeric(cut2(*******ADD YOUR CODE HERE*******, g=*******ADD YOUR CODE HERE*******)))]
  
  # Overall RFM score
  temp[,finalscore:=*******ADD YOUR CODE HERE******* *recency +
         w*******ADD YOUR CODE HERE******* *frequency + 
         *******ADD YOUR CODE HERE******* *monetary]  
  
  print("Overall RFM Measure done")
  
  # RFM group
  temp[,group:=round(*******ADD YOUR CODE HERE*******)]
