...
plot1 <- ggplot(rfm_scores, aes(recency)) +
  *******ADD YOUR CODE HERE*******(fill="blue", bins = 20) + 
  *******ADD YOUR CODE HERE*******("Histogram: Recency Score") +
  *******ADD YOUR CODE HERE*******("Recency Score") + *******ADD YOUR CODE HERE*******("Count")

plot2 <- ggplot(rfm_scores, aes(frequency)) +
  *******ADD YOUR CODE HERE*******(fill="green", bins = 20) +
  *******ADD YOUR CODE HERE*******("Histogram: Frequency Score") +
  *******ADD YOUR CODE HERE*******("Frequency Score") + *******ADD YOUR CODE HERE*******("Count")

plot3 <- ggplot(rfm_scores, aes(monetary)) +
  *******ADD YOUR CODE HERE*******(fill="red", bins = 20) +
  *******ADD YOUR CODE HERE*******("Histogram: Monetary Value Score") +
  *******ADD YOUR CODE HERE*******("Monetary Value Score") + *******ADD YOUR CODE HERE*******("Count")  
